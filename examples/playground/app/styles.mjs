...
export const PLAYGROUND_UTILITY_CLASSES = Object.freeze({
  ...
  header: 'sticky top-0 z-10 flex h-[72px] items-center gap-5 border-b border-slate-200 bg-white/90 px-7 backdrop-blur max-[900px]:grid max-[900px]:h-auto max-[900px]:min-h-[72px] max-[900px]:grid-cols-[1fr_auto] max-[900px]:gap-x-4 max-[900px]:gap-y-2 max-[900px]:px-5 max-[900px]:py-3 max-[520px]:min-h-[112px] max-[520px]:grid-cols-[auto_1fr] max-[520px]:gap-2.5 max-[520px]:px-3.5 max-[520px]:pb-11 max-[520px]:pt-2.5 dark:border-slate-700 dark:bg-slate-900/90',
  'header-title': 'min-w-[180px] max-[520px]:absolute max-[520px]:left-3.5 max-[520px]:top-[68px] max-[520px]:min-w-0',
  context: 'ml-auto flex gap-3 text-xs text-slate-500 max-[900px]:justify-self-end max-[520px]:hidden dark:text-slate-400',
  weather: 'max-[520px]:hidden', toolbar: 'flex items-center gap-2 max-[900px]:col-span-2 max-[900px]:w-full max-[900px]:justify-end max-[520px]:col-span-1 max-[520px]:col-start-2 max-[520px]:row-start-1 max-[520px]:ml-auto max-[520px]:w-auto max-[520px]:gap-1',
  ...
  'segmented-mode': 'inline-flex rounded-lg border border-slate-200 bg-slate-50 p-1 dark:border-slate-700 dark:bg-slate-800',
