...
export function renderShell() {
 return applyUtilities(`<div class="layout">
  ...
  <main id="content" class="min-w-0"><header class="header"><button id="mobile-navigation-toggle" class="icon-button hamburger" aria-label="Open navigation" aria-expanded="false">☰</button><div class="header-title"><div id="breadcrumbs" class="flex gap-1.5 text-[11px] text-slate-500 dark:text-slate-400"></div><strong id="page-title" class="mt-1 block text-[15px]">Overview</strong></div><div class="context"><span class="weather">Lagos&nbsp; 27°C</span><span class="clock" id="clock">--:--</span></div><div class="toolbar"><button id="access-token" class="pill max-[520px]:hidden" type="button">Access token</button><button id="shipping-mode-switch" class="pill" type="button" data-mode="sfn">Export</button><button id="theme-toggle" class="icon-button" type="button" aria-label="Use dark theme">☾</button><button id="notifications" class="icon-button" type="button" aria-label="Notifications">♢<span class="notification-dot"></span></button><button id="account-menu" class="account" type="button" aria-haspopup="menu" aria-expanded="false"><span class="avatar">AO</span><span class="max-[520px]:hidden"><strong class="block text-[11px]">Amara Okafor</strong><small class="mt-0.5 block text-[11px] text-slate-500 dark:text-slate-400">Operations</small></span><span class="max-[520px]:hidden">⌄</span></button></div></header>
