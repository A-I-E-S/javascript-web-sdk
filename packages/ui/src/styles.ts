...
[part="alert"],[part="toast"]{display:flex;gap:.75rem;border:1px solid var(--africanies-border,#d8dde7);border-radius:.5rem;background:var(--africanies-surface,#fff);padding:.75rem 1rem;align-items:flex-start}[part="alert"] [part="icon"],[part="toast"] [part="icon"]{color:var(--africanies-accent,currentColor);flex:none}[part="content"]{display:flex;min-width:0;flex:1;flex-direction:column;gap:.25rem}[part="message"]{margin:0}[data-variant="danger"]{--africanies-accent:var(--africanies-danger,#dc2626)}[data-variant="warning"]{--africanies-accent:var(--africanies-warning,#ca8a04)}[data-variant="success"],[data-variant="export"]{--africanies-accent:var(--africanies-export,#1cbd5d)}[data-variant="import"]{--africanies-accent:var(--africanies-import,#f08829)}
[part="chip"]{display:inline-flex;align-items:center;gap:.25rem;border-radius:.375rem;background:var(--africanies-surface-muted,#eef1f5);padding:.125rem .5rem;font-size:.75rem;font-weight:600}[part="chip"][data-size="md"]{padding:.25rem .625rem;font-size:.875rem}[part="chip"][data-variant="success"],[part="chip"][data-variant="export"]{background:color-mix(in srgb,var(--africanies-export,#1cbd5d) 12%,#fff);color:var(--africanies-export,#1cbd5d)}[part="chip"][data-variant="warning"]{background:color-mix(in srgb,var(--africanies-warning,#ca8a04) 12%,#fff);color:var(--africanies-warning,#ca8a04)}[part="chip"][data-variant="danger"]{background:color-mix(in srgb,var(--africanies-danger,#dc2626) 12%,#fff);color:var(--africanies-danger,#dc2626)}[part="chip"][data-variant="import"]{background:color-mix(in srgb,var(--africanies-import,#f08829) 12%,#fff);color:var(--africanies-import,#f08829)}
