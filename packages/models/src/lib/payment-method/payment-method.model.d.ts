import type { CurrencyModel, CurrencyPaymentMethodPivotModel } from '../currency/currency.model.js';
/**
 ...
 */
export interface PaymentMethodCurrencyModel extends Omit<CurrencyModel, 'payment_methods'> {
