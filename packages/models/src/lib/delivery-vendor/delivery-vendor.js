 ...
 * @param value
 */
export function normalizeDeliveryVendor(value) {
 ...
 * @param value
 */
export function isKnownDeliveryVendor(value) {
 ...
 * @param value
 */
export function normalizeDeliveryVendorForForm(value) {
 ...
 * @param value
 */
export function deliveryVendorLabel(value) {
    const normalized = normalizeDeliveryVendor(value);
...
//# sourceMappingURL=delivery-vendor.js.map