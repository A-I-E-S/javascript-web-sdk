 ...
 */
export type FilterOptionsSource = 'shipmentMethods' | 'warehouses' | 'shipmentManifests' | 'static';
/**
 ...
 * @param config
 */
export declare function resolveFilterTransport(config: Pick<ModuleFilterConfigModel, 'transport'>): FilterTransport;
//# sourceMappingURL=filter-config.model.d.ts.map